 ...
 */
class Esparkinfo_Imageuploader_Block_Adminhtml_Imageupload_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return Esparkinfo_Imageuploader_Block_Adminhtml_Imageupload_Edit_Tab_Stores
     * @author Ultimate Module Creator
     */
