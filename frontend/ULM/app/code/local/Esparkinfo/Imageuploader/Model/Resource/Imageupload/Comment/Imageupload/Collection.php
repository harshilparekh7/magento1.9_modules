 ...
 */
/**
 * Imageupload comments resource collection model
 *
 * @category    Esparkinfo
 * @package     Esparkinfo_Imageuploader
 * @author      Ultimate Module Creator
 */
class Esparkinfo_Imageuploader_Model_Resource_Imageupload_Comment_Imageupload_Collection extends Esparkinfo_Imageuploader_Model_Resource_Imageupload_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('esparkinfo_imageuploader/imageupload_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.imageupload_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('esparkinfo_imageuploader/imageupload_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.imageupload_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
